<?php
	...
	namespace FasoDev\Components\Http\Clients\Curl;
	
	use CurlHandle;
	use FasoDev\Components\Http\Clients\ClientInterface;
	...
	class CurlClient implements ClientInterface
	{
		...
		{
			return $this->request($url, 'GET', $queries, $options['headers'] ?? []);
		}
		...
		{
			return $this->request($url, 'POST', $data, $options['headers'] ?? []);
		}
		...
		private function request(
			...
			string $method,
			array  $data = [],
			array  $headers = []): ClientResponseInterface
		{
